...
Si_reporte.findByIdSi_modulo = (idSi_modulo, created_by, next) => {
    ...
    let keys = [];
    if (created_by) {
        query = 'SELECT si_reporte.*, _Modulo_idsi_modulo.nombre as si_modulo_Modulo_idsi_modulo FROM si_reporte INNER JOIN si_modulo as _Modulo_idsi_modulo ON _Modulo_idsi_modulo.idsi_modulo = si_reporte.Modulo_idsi_modulo   WHERE si_reporte.si_modulo_idsi_modulo = ? AND si_reporte.created_by = ? HAVING si_reporte.baja IS NULL OR si_reporte.baja = false';
        keys = [idSi_modulo, created_by];
    } else {
        query = 'SELECT si_reporte.*, _Modulo_idsi_modulo.nombre as si_modulo_Modulo_idsi_modulo FROM si_reporte INNER JOIN si_modulo as _Modulo_idsi_modulo ON _Modulo_idsi_modulo.idsi_modulo = si_reporte.Modulo_idsi_modulo   WHERE si_reporte.si_modulo_idsi_modulo = ? HAVING si_reporte.baja IS NULL OR si_reporte.baja = false';
        keys = [idSi_modulo];
    }
...
Si_reporte.all = (created_by, next) => {
    ...
    let keys = [];
    if (created_by) {
        query = 'SELECT si_reporte.*, _Modulo_idsi_modulo.nombre as si_modulo_Modulo_idsi_modulo FROM si_reporte INNER JOIN si_modulo as _Modulo_idsi_modulo ON _Modulo_idsi_modulo.idsi_modulo = si_reporte.Modulo_idsi_modulo   WHERE si_reporte.created_by = ? HAVING si_reporte.baja IS NULL OR si_reporte.baja = false';
        keys = [created_by];
    } else {
