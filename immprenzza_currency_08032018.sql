...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2018 a las 19:45:03
...
--
-- Base de datos: `immprenzza_currency_08032018`
--
...
--
-- Estructura de tabla para la tabla `categoriabazar`
--

CREATE TABLE `categoriabazar` (
  `idcategoriabazar` varchar(30) NOT NULL COMMENT '1|Id Categoria Bazar',
  `nombre` varchar(45) NOT NULL COMMENT '1|Descripción',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Categoría de Bazar';
...
CREATE TABLE `categoriacomida` (
  `idcategoriacomida` varchar(20) NOT NULL COMMENT '1|Id Categoria',
  `nombre` varchar(45) NOT NULL COMMENT '1|Nombre de Categoría',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Categoría de Comida';
...
CREATE TABLE `diasemana` (
  `iddiasemana` varchar(9) NOT NULL COMMENT '1|Dia de la semana',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Dias de la Semana';
...
CREATE TABLE `entidad` (
  `identidad` int(11) NOT NULL COMMENT '0|',
  `nombre` varchar(45) DEFAULT NULL COMMENT '1|Entidad',
  `pais_idpais` int(11) NOT NULL COMMENT '1|Pais|nombre',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Entidades';
...
--
-- Estructura de tabla para la tabla `estadobazar`
--

CREATE TABLE `estadobazar` (
  `idestadobazar` varchar(25) NOT NULL COMMENT '1|Estado Bazar',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Estados de Bazar';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `estadocomida`
--

CREATE TABLE `estadocomida` (
  `idestadocomida` varchar(20) NOT NULL COMMENT '1|Estado',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Estados de Cocina';
...
CREATE TABLE `estadopublicacion` (
  `idestadopublicacion` varchar(25) NOT NULL COMMENT '1|Estado de Publicación',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Estado de Publicación';
...
CREATE TABLE `estadotrabajo` (
  `idestadotrabajo` varchar(25) NOT NULL COMMENT '1|Estado Bolsa de Trabajo',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Estados de Bolsa de Trabajo';
...
CREATE TABLE `frecuencia` (
  `idfrecuencia` varchar(15) NOT NULL COMMENT '1|Frecuencia de Pago',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Frecuencias de Pago';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `imagentipo`
--

CREATE TABLE `imagentipo` (
  `idimagentipo` varchar(10) NOT NULL,
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
...
CREATE TABLE `ingrediente` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Ingredientes';
...
CREATE TABLE `metodopago` (
  `idmetodopago` varchar(20) NOT NULL COMMENT '1|Método de Pago',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Método de Pago';
...
CREATE TABLE `pais` (
  `idpais` int(11) NOT NULL COMMENT '0|',
  `nombre` varchar(45) DEFAULT NULL COMMENT '1|Pais',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Paises';
...
CREATE TABLE `tarjeta` (
  `idtarjeta` int(11) NOT NULL COMMENT '0|',
  `numero` varchar(20) NOT NULL COMMENT '1|Número',
  `banco` binary(60) NOT NULL COMMENT '0|Banco',
  `vigencia` binary(60) NOT NULL COMMENT '0|Vigencia',
  `clave` binary(60) NOT NULL COMMENT '0|Clave',
  `empresa_idempresa` int(11) NOT NULL COMMENT '1|Empresa|nombre',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Tarjetas';
...
CREATE TABLE `tipoinmueble` (
  `idtipoinmueble` varchar(15) NOT NULL COMMENT '1|Tipo de Inmueble',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Tipo de Inmueble';
...
CREATE TABLE `tipopublicacion` (
  `idtipopublicacion` varchar(15) NOT NULL COMMENT '1|Tipo de Publicación (Renta/Venta)',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Tipo de Publicación';
...
CREATE TABLE `unidadmedida` (
  `idunidadmedida` varchar(15) NOT NULL COMMENT '1|Unidad de Medida',
  `baja` tinyint(1) DEFAULT NULL COMMENT '0|',
  `created_by` int(11) DEFAULT NULL COMMENT '0|',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '0|',
  `modified_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '0|'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='1|1|Unidades de Medida';
...
ALTER TABLE `accuracytiempo`
  ADD PRIMARY KEY (`idaccuracytiempo`,`retraso`),
...
--
-- Indices de la tabla `categoriabazar`
--
ALTER TABLE `categoriabazar`
  ADD PRIMARY KEY (`idcategoriabazar`);

--
-- Indices de la tabla `categoriacomida`
--
ALTER TABLE `categoriacomida`
  ADD PRIMARY KEY (`idcategoriacomida`),
  ADD UNIQUE KEY `idcategoriacomida_UNIQUE` (`idcategoriacomida`);
...
ALTER TABLE `diasemana`
  ...
  ADD UNIQUE KEY `iddiasemana_UNIQUE` (`iddiasemana`);
...
ALTER TABLE `entidad`
  ...
  ADD KEY `fk_entidad_pais1_idx` (`pais_idpais`);
...
--
-- Indices de la tabla `estadobazar`
--
ALTER TABLE `estadobazar`
  ADD PRIMARY KEY (`idestadobazar`),
  ADD UNIQUE KEY `idestadobolsa_UNIQUE` (`idestadobazar`);

--
-- Indices de la tabla `estadocomida`
--
ALTER TABLE `estadocomida`
  ADD PRIMARY KEY (`idestadocomida`),
  ADD UNIQUE KEY `idestadocomida_UNIQUE` (`idestadocomida`);
...
ALTER TABLE `estadopublicacion`
  ...
  ADD UNIQUE KEY `idestadopublicacion_UNIQUE` (`idestadopublicacion`);
...
--
-- Indices de la tabla `estadotrabajo`
--
ALTER TABLE `estadotrabajo`
  ADD PRIMARY KEY (`idestadotrabajo`),
  ADD UNIQUE KEY `idestadobolsa_UNIQUE` (`idestadotrabajo`);
...
ALTER TABLE `frecuencia`
  ...
  ADD UNIQUE KEY `idfrecuencia_UNIQUE` (`idfrecuencia`);

--
-- Indices de la tabla `imagentipo`
--
ALTER TABLE `imagentipo`
  ADD PRIMARY KEY (`idimagentipo`),
  ADD UNIQUE KEY `idimagentipo_UNIQUE` (`idimagentipo`);
...
ALTER TABLE `metodopago`
  ...
  ADD UNIQUE KEY `idmetodopago_UNIQUE` (`idmetodopago`);
...
ALTER TABLE `tarjeta`
  ...
  ADD KEY `fk_tarjeta_empresa1_idx` (`empresa_idempresa`);
...
ALTER TABLE `tipopublicacion`
  ...
  ADD UNIQUE KEY `idtipopublicacion_UNIQUE` (`idtipopublicacion`);
...
--
ALTER TABLE `accuracyestimacion`
  MODIFY `idaccuracyestimacion` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|Idaccuracytiempo';
--
-- AUTO_INCREMENT de la tabla `accuracytiempo`
--
ALTER TABLE `accuracytiempo`
  MODIFY `idaccuracytiempo` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|Idaccuracytiempo';
--
...
--
ALTER TABLE `checkout`
  MODIFY `idcheckout` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=2738;
--
...
--
ALTER TABLE `empleadotareaestado`
  MODIFY `idempleadotareaestado` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `entidad`
--
ALTER TABLE `entidad`
  MODIFY `identidad` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|';
--
...
--
ALTER TABLE `ordentareaestado`
  MODIFY `idordentareaestado` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT de la tabla `pais`
--
ALTER TABLE `pais`
  MODIFY `idpais` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|';
--
...
--
ALTER TABLE `si_modulo`
  MODIFY `idsi_modulo` int(4) NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=66;
--
...
--
ALTER TABLE `tarjeta`
  MODIFY `idtarjeta` int(11) NOT NULL AUTO_INCREMENT COMMENT '0|';
--
...
--
ALTER TABLE `entidad`
  ADD CONSTRAINT `fk_entidad_pais1` FOREIGN KEY (`pais_idpais`) REFERENCES `pais` (`idpais`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tarjeta`
  ADD CONSTRAINT `fk_tarjeta_empresa1` FOREIGN KEY (`empresa_idempresa`) REFERENCES `empresa` (`idempresa`) ON DELETE NO ACTION ON UPDATE NO ACTION;
